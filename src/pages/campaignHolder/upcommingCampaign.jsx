...
const TABLE_HEAD = ["Beneficiary", "Country","Current donation", "Progess", "Goal", "Date Created"," "];
...
export default function UpcommingCampaigns() {
        ...
        <Card className="h-full w-full mt-4">
            <CardHeader floated={false} shadow={false} className="rounded-none">
                <div className="my-2 flex items-center justify-between gap-2 md:flex-row flex-col">
                    ...
                    <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                        <Button className="flex items-center gap-3 bg-yellow-900" size="sm" onClick={()=>navigate("/create-campaign")}>
            ...
            <CardBody className="overflow-scroll px-0">
                <table className="mt-4 w-full min-w-max table-auto text-left">
                    ...
                    <tbody>
                        {TABLE_ROWS.map(
                            ({ img, name, email, job, donation,online,goal, date }, index) => {
