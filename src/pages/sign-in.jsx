...
export function SignIn() {
  return (
    <section className="m-8 flex gap-4">
      <div className="w-full lg:w-3/5 flex justify-center items-center flex-col h-[90vh]">
        ...
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          <div className="space-y-4 mt-8">
            <Button size="lg" className="flex items-center gap-2 justify-center shadow-md bg-yellow-900" fullWidth>
      ...
      <div className="absolute top-0 h-full w-2/5 bg-green-900/90 bg-cover bg-center z-10" />
      <div className="absolute top-0 h-full w-2/5 bg-[url('/img/backimage.svg')] bg-cover bg-center" />
      </div>
      </Link>
