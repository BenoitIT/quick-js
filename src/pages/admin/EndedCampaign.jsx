...
const TABLE_HEAD = ["Beneficiary","Creator", "Country", "Progess", "Goal", "Date Created", " "];
...
export default function AdminEndedCampaigns() {
        ...
        <Card className="h-full w-full mt-4">
            ...
            <CardBody className="overflow-scroll px-0">
                <table className="mt-4 w-full min-w-max table-auto text-left">
                    ...
                    <tbody>
                        {TABLE_ROWS.map(
                            ({ img,creator, name, email, job, online, goal, date }, index) => {
