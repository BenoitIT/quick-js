                    ...
                    <div className="mx-auto  grid  grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="w-full">
                            ...
                            <div className="mt-6 flex md:flex-row gap-2 flex-col">
                                ...
                                <Button className="bg-white border md:min-w-[300px] min-w-fit capitalize text-black hover:bg-green-900/80">Donate now</Button>
                            </div>
                            ...
                            <Card variant="gradient" className="w-full max-w-[23rem] p-8 shadow-lg drop-shadow-md h-fit">
                                ...
                                >
                                    ...
                                    <div className="mt-6 flex flex-col">
                                        ...
                                        <Button className="bg-yellow-900 mt-2 md:min-w-[300px] min-w-fit capitalize text-black">Donate now</Button>
                                    </div>
                                </CardHeader>
